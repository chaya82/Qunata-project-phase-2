<%@ Page Title="Register" Language="C#" MasterPageFile="~/Account/Site1.Master" AutoEventWireup="true"
    CodeBehind="NewRegister.aspx.cs" Inherits="Quanta.Account.NewRegister" %>
...
<%--
                    ...
                    --%>
                                ...
                                I am authorized to respond to a survey on my company's HR practices, and consent to the submitted information being used in accordance with the <a href="#">privacy policy</a><br />
                            <asp:Label ID="lblchk" runat="server" ForeColor="Red"></asp:Label>
                            <asp:CustomValidator ID="ValTerms" ClientValidationFunction="ValidateCheckBoxes" runat="server"  Display="Dynamic"
                            ErrorMessage="Please Accept Terms Of Use." ValidationGroup="RegisterUserValidationGroup">
