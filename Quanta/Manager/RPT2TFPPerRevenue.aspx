<%@ Page Title="" Language="C#" MasterPageFile="~/Manager/Inner.Master" AutoEventWireup="true" CodeBehind="RPT2TFPPerRevenue.aspx.cs" Inherits="Quanta.Manager.RPT2TFPPerRevenue" %>
        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item">TFP/ Revenue</div>
            </div>
          </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            type: "POST",
            url: "RPT2TFPPerRevenue.aspx/Revenue_employee",
            data: '{}',
