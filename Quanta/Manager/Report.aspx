<%@ Page Title="" Language="C#" MasterPageFile="~/Manager/Inner.Master" AutoEventWireup="true" CodeBehind="Report.aspx.cs" Inherits="Quanta.Manager.Report" %>
  ...
  var options = {
   ...
   function getPie(url,id,title,no,cnvno) {
    ...
    'fullscreen=yes', // only works in IE, but here for completeness
            ...
            var cont="<html xmlns='http://www.w3.org/1999/xhtml'> ";
            cont=cont+" <title>Quanta</title>";
            cont=cont+"<link rel='stylesheet' href='/assets/css/app.min.css'>";
   cont=cont+"<link rel='stylesheet' href='/assets/bundles/jquery-selectric/selectric.css'>";
 
     cont=cont+"<link rel='stylesheet' href='/assets/bundles/datatables/datatables.min.css'>";
     cont=cont+"<link rel='stylesheet' href='/assets/bundles/datatables/DataTables-1.10.16/css/dataTables.bootstrap4.min.html'>";
 
     cont=cont+"<link rel='stylesheet' href='/assets/css/style.css?v=1.0'>";
     cont=cont+"<link rel='stylesheet' href='/assets/css/components.css'><body>";
     cont=cont+"<div style='margin:20px'>";
     dataur.sort((a, b) => (a.title - b.title));
     var x;
//for (x in dataur) {
for (x = 0; x < dataur.length; x++) {
 if(dataur[x].title==1 )
 {
  var str="<h4>Head Count</h4> <hr /><div class='row'>   <div class='col-6 col-md-6 col-lg-6' style='text-align:center'><img src='"+dataur[x].url+"' /> </div><div class='col-6 col-md-6 col-lg-6'><p style='text-align:justify'>The headcount is simply the number of people employed by a business at a given time.<br /><br />Organization level: The attached graph shows the trend (If multi-year data has been provided) of change in Organization Level Headcount.  <br /><br />Headcount by Function/ Department: The graph show the current spread of headcount across different departments. The % indicates the Department Headcount as a % of Total Headcount and can help you spot any pockets of over/ under staffing</p> </div></div>  <hr />";
 
 
  }
  else if(dataur[x].title==2 )
 {
  var str="<h4>Age Spread</h4> <hr /><div class='row'><div class='col-6 col-md-6 col-lg-6' style='text-align:center'><img src='"+dataur[x].url+"' /> </div><div class='col-6 col-md-6 col-lg-6'><p style='text-align:justify'>The Age distribution in an organization is an indicator of staff age demographic in different departments and levels</br></br>You can see the age distribution of your employees in different departments and levels as well as the average age for each department and level</br></br>This can help in identifying levels where a high age average can be indicative of career plateaus, functions that may be lacking desired ageprofile or potential scenario of high number of retiring staff in levels or functions </p> </div></div>  <hr />";
 
 
  }
   else if(dataur[x].title==3 )
 {
  var str="<h4>Tenure Spread</h4> <hr /><div class='row'><div class='col-6 col-md-6 col-lg-6' style='text-align:center'><img src='"+dataur[x].url+"' /> </div><div class='col-6 col-md-6 col-lg-6'><p style='text-align:justify'>The Tenure distribution in an organization is an indicator of staff retention/ organizational experience in different departments and levels<br />You can see the Tenure distribution of your employees in different departments and levels as well as the average tenure for each department and level<br />This can help in identifying Levels and Departments with high or low tenure compared to the Organizational average. Indicative of possible lack of fresh blood in the company or lack of organizational experience. Ideal company spreads should have a balance between organizational experience and new perspectives. Low tenure averages can also reflect on the organization’s ability to retain staff </p> </div></div>  <hr />";
 
 
  }
   else if(dataur[x].title==4 )
 {
  var str="<h4>Diversity</h4> <hr /><div class='row'><div class='col-6 col-md-6 col-lg-6' style='text-align:center'><img src='"+dataur[x].url+"' /> </div><div class='col-6 col-md-6 col-lg-6'><p style='text-align:justify'>Research has shown that diversity has a positive impact on organizational productivity. Gender Diversity refers to the ratio of men and women in the workforce. It is an indicator of an employer’s commitment to providing equal opportunities to men and women. <br /><br />You can see the Gender distribution in your workforce and in different departments and levels. Seeing the skew in the gender distribution, you can identify pockets of the organization where focused action might be required for enhancing gender diversity.</p> </div></div>  <hr />";
 
 
  }
   else if(dataur[x].title==5 )
 {
  var str="<h4>Pyramid</h4> <hr /><div class='row'><div class='col-6 col-md-6 col-lg-6' style='text-align:center'><img src='"+dataur[x].url+"' /> </div><div class='col-6 col-md-6 col-lg-6'><p style='text-align:justify'>The organization pyramid shows the distribution of staff strength across different levels and grades. Typically the pyramids are broad at the bottom and narrow at the top.              <br /><img src='../images/Pyramid representation.png' style='width:50%' />               <br />  By looking at the shape of your organizational pyramid, you can see possible levels which may be overstaffed or understaffed. </p> </div></div>  <hr />";
 
 
  }
   else if(dataur[x].title==6 )
 {
  var str="<h4>Span of Control</h4> <hr /><div class='row'><div class='col-6 col-md-6 col-lg-6' style='text-align:center'><img src='"+dataur[x].url+"' /> </div><div class='col-6 col-md-6 col-lg-6'><p style='text-align:justify'>Span of control indicates the number of subordinates a supervisor has and for an organization or team is represented as an average ratio.<br /><br />This is a very helpful metric for determining manager utilization. A very low SpOC can be indicative of under utilization of the managers and a very high SpOC can indicate over burdening of the manager (thereby reducing their effectiveness). </p> </div></div>  <hr />";
 
 
  }
   else if(dataur[x].title==7 )
 {
  var str="<h4>Total Fixed Pay</h4> <hr /><div class='row'><div class='col-6 col-md-6 col-lg-6' style='text-align:center'><img src='"+dataur[x].url+"' /> </div><div class='col-6 col-md-6 col-lg-6'><p style='text-align:justify'>Total Fixed Pay represents the aggregate of the fixed wage cost for the organization<br />By looking at the TFP spread for departments and for levels you can determine if there is a skew/ disproportionate allocation in TFP for any pocket. It can help provide direction for any correction/ more equitable distribution.</p> </div></div>  <hr />";
 
 
  }
   else if(dataur[x].title==8 )
 {
  var str="<h4>Performance Spread</h4> <hr /><div class='row'><div class='col-6 col-md-6 col-lg-6' style='text-align:center'><img src='"+dataur[x].url+"' /> </div><div class='col-6 col-md-6 col-lg-6'><p style='text-align:justify'>The performance spread indicates what % of the employees are falling in which performance category at the organization, Department and Grade levels<br /><br />It is a good way to identify overall spread in light of business performance (assuming good business performance reflects good individual performance and vice versa) and also potential biases in performance rating spread in any department/ level.</p> </div></div>  <hr />";
 
 
  }
   else if(dataur[x].title==9 )
 {
  var str="<h4>Attrition</h4> <hr /><div class='row'><div class='col-6 col-md-6 col-lg-6' style='text-align:center'><img src='"+dataur[x].url+"' /> </div><div class='col-6 col-md-6 col-lg-6'><p style='text-align:justify'>Indicates the % of employees who are leaving the organization each year.<br /><br />Reflects on the ability of the organization to retain staff. A reducing trend in attrition is considered positive</p> </div></div>  <hr />";
 
 
  }
  else{
   var str="<div class='row'><div class='col-12 col-md-12 col-lg-12' style='text-align:center'><img src='"+dataur[x].url+"' /> </div></div>  <hr />"
  }
  cont=cont+str;
}
            cont=cont+"<div class='row'><div class='col-6 col-md-6 col-lg-6'>&nbsp;</div><div class='col-6 col-md-6 col-lg-6'><a class='btn btn-warning add-btn' href='javascript:window.print();'>Print</a></div></div></div></body></html>";
